...
const Arrange: Page = () => (
  <Stage>
    ...
    <Dot id="a" left={676} top={494} size={122} color="var(--of-accent)" />
...
const Shift: Page = () => (
  <Stage>
    ...
    <Dot id="a" left={748} top={346} size={76} color="var(--of-accent)" />
...
const Scale: Page = () => (
  <Stage>
    ...
    <Dot id="a" left={574} top={320} size={154} color="var(--of-accent)" />
...
const Settle: Page = () => (
  <Stage>
    ...
    <Dot id="a" left={776} top={476} size={96} color="var(--of-accent)" />
