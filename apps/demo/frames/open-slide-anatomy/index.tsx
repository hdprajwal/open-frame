import { type DesignSystem, type FrameMeta, type Page, useFramePageNumber } from '@open-frame/core';
...
const Footer = ({ section }: { section: string }) => {
  ...
  return (
    ...
    >
      <span>
        <span style={{ color: 'var(--of-accent)', marginRight: 12 }}>●</span>
        {section}
...
const Cover: Page = () => (
  <div style={{ ...fill, padding: '120px 100px' }}>
    ...
    >
      ...
      >
        How a <span style={{ color: 'var(--of-accent)' }}>Page[]</span> becomes a
...
const Agenda: Page = () => {
  const items: { n: string; label: string; tint: string }[] = [
    { n: '01', label: 'The mental model — a deck is a Page[]', tint: 'var(--of-accent)' },
    { n: '02', label: 'The file contract — what every slide exports', tint: 'var(--of-accent)' },
      ...
      >
        <div style={{ animation: 'osa-fadeUp 600ms ease-out 200ms both' }}>
          <p style={{ fontSize: 34, lineHeight: 1.55, color: text2, margin: 0 }}>
            Every slide file{' '}
            <code style={{ color: 'var(--of-accent)', fontFamily: 'var(--of-font-display)' }}>
              export default
            </code>
          ...
          <p style={{ fontSize: 30, lineHeight: 1.5, color: muted, margin: 0 }}>
            ...
            <em style={{ color: text2, fontStyle: 'normal' }}>
              "render{' '}
              <code style={{ fontFamily: 'var(--of-font-display)', color: 'var(--of-accent)' }}>
                pages[index]
              </code>{' '}
              at 1920×1080"
            </em>{' '}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          {pages.map((label, i) => (
            ...
            >
              ...
              <span style={{ fontSize: 30, color: text2, fontFamily: 'var(--of-font-display)' }}>
                {label}
              </span>
              <span
                aria-hidden
                style={{
                  ...
                  height: 10,
                  borderRadius: 999,
                  background: i === 0 ? 'var(--of-accent)' : rule,
...
const FileContract: Page = () => {
  const lines: { code: ReactNode; tag?: string; tagColor?: string }[] = [
    ...
    { code: <>&nbsp;</> },
    {
      code: (
        <>
          <Token c={violet}>export const</Token> <Token c={'var(--of-accent)'}>design</Token>:{' '}
    ...
    { code: <>&nbsp;</> },
    {
      code: (
        <>
          <Token c={violet}>export const</Token> <Token c={'var(--of-accent)'}>meta</Token>:{' '}
  ...
  return (
    <div style={{ ...fill, padding: '120px 100px' }}>
      ...
      <p style={{ fontSize: 30, color: text2, lineHeight: 1.5, margin: 0, maxWidth: 1600 }}>
        ...
        under your{' '}
        <code style={{ fontFamily: 'var(--of-font-display)', color: mint }}>slides/</code> directory
        and turns each hit into an id.
      </p>
      <div style={{ height: 56 }} />
      <div
        style={{
      ...
      >
        ...
        >
          ...
          <div style={{ color: 'var(--of-accent)' }}>virtual:open-slide/slides</div>
          <div style={{ height: 14 }} />
...
const FlowArrow = ({ delay = 0 }: { delay?: number }) => (
  <svg width="80" height="40" viewBox="0 0 80 40" style={{ overflow: 'visible' }}>
    ...
    />
    <polygon points="64,12 80,20 64,28" fill="var(--of-accent)" />
  </svg>
);
...
const RenderPipeline: Page = () => {
  const stages = [
    { label: '/s/<id>', sub: 'route match', tint: 'var(--of-accent)' },
    ...
    { label: '<SlideCanvas>', sub: '1920×1080', tint: 'var(--of-accent)' },
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 18, position: 'relative' }}>
        {stages.map((s, i) => (
          ...
          >
            ...
            >
              <code style={{ fontFamily: 'var(--of-font-display)', fontSize: 30, color: s.tint }}>
                {s.label}
              </code>
              <span
                style={{
      ...
      >
        <div style={{ animation: 'osa-fadeUp 600ms ease-out 200ms both' }}>
          <p style={{ fontSize: 30, color: text2, lineHeight: 1.55, margin: 0 }}>
            ...
            mounts a{' '}
            <code style={{ fontFamily: 'var(--of-font-display)', color: mint }}>
              ResizeObserver
            </code>{' '}
            on its container, computes the fit factor, and applies{' '}
            <code style={{ fontFamily: 'var(--of-font-display)', color: warm }}>
              transform: scale(s)
            </code>
            .
          </p>
          ...
          >
            ...
            <span style={{ color: 'var(--of-accent)' }}>s</span> ={' '}
          ...
          >
            <li style={{ marginBottom: 10 }}>
              <span style={{ color: 'var(--of-accent)' }}>›</span> design as if the viewport{' '}
              <em style={{ fontStyle: 'normal', color: text2 }}>is</em> 1920×1080
            </li>
            <li style={{ marginBottom: 10 }}>
              <span style={{ color: 'var(--of-accent)' }}>›</span> use absolute pixel values
              everywhere
            </li>
            <li>
              <span style={{ color: 'var(--of-accent)' }}>›</span> overflow past 1080 is silently
              cropped
            </li>
          </ul>
        </div>
...
const HotReload: Page = () => {
  const steps = [
    ...
    { time: 't ≈ 8ms', label: 'chokidar fires "change"', tint: 'var(--of-accent)' },
  ...
  return (
    <div style={{ ...fill, padding: '120px 100px' }}>
      ...
      <div style={{ height: 24 }} />
      <p style={{ fontSize: 30, color: text2, lineHeight: 1.5, margin: 0, maxWidth: 1600 }}>
        Edit a slide file → <span style={{ color: 'var(--of-accent)' }}>Fast Refresh</span>. Add or
      ...
      <div style={{ position: 'relative', paddingLeft: 40 }}>
        <div
          ...
          style={{
            ...
            bottom: 8,
            width: 2,
            background: `linear-gradient(${muted}, ${'var(--of-accent)'}, ${mint}, ${warm}, ${violet})`,
            opacity: 0.5,
          }}
        />
        {steps.map((s, i) => (
...
const DesignSystemPage: Page = () => {
  const vars: { name: string; from: string; tint: string }[] = [
    { name: '--of-bg', from: 'palette.bg', tint: 'var(--of-accent)' },
    { name: '--of-text', from: 'palette.text', tint: 'var(--of-accent)' },
    { name: '--of-accent', from: 'palette.accent', tint: 'var(--of-accent)' },
    { name: '--of-font-display', from: 'fonts.display', tint: mint },
    { name: '--of-font-body', from: 'fonts.body', tint: mint },
    { name: '--of-size-hero', from: 'typeScale.hero', tint: warm },
    { name: '--of-size-body', from: 'typeScale.body', tint: warm },
    { name: '--of-radius', from: 'radius', tint: violet },
  ];
  return (
    <div style={{ ...fill, padding: '120px 100px' }}>
      <style>{keyframes}</style>
      ...
      <p style={{ fontSize: 30, color: text2, lineHeight: 1.5, margin: 0, maxWidth: 1600 }}>
        ...
        <code style={{ fontFamily: 'var(--of-font-display)', color: mint }}>designToCssVars()</code>{' '}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16 }}>
        {vars.map((v, i) => (
          ...
          >
            <code style={{ fontFamily: 'var(--of-font-display)', fontSize: 24, color: muted }}>
              design.{v.from}
            </code>
...
const DesignPanelWrite: Page = () => {
  const ring = [
    { label: 'drag slider', tint: 'var(--of-accent)', sub: 'panel UI' },
    { label: 'live --of-* update', tint: mint, sub: 'in-memory CSS var' },
    { label: 'click Save', tint: warm, sub: 'commit' },
    { label: 'PUT /design/<id>', tint: violet, sub: 'design-plugin endpoint' },
    { label: 'Babel parse → AST', tint: 'var(--of-accent)', sub: 'find const design' },
  ...
  return (
    <div style={{ ...fill, padding: '120px 100px' }}>
      ...
      <p style={{ fontSize: 30, color: text2, lineHeight: 1.5, margin: 0, maxWidth: 1700 }}>
        ...
        <span style={{ color: 'var(--of-accent)' }}>Save</span> turns the draft into a Babel AST
        rewrite of the
        <code style={{ fontFamily: 'var(--of-font-display)', color: warm }}> design </code>
      ...
      >
        {ring.map((r, i) => (
          ...
          >
            ...
            <div style={{ fontSize: 18, color: muted, fontFamily: 'var(--of-font-display)' }}>
              {r.sub}
            </div>
          </div>
        ))}
      ...
      >
        ...
        >
          ...
          >
            ...
            {'\n  '}
            <span style={{ color: 'var(--of-accent)' }}>style</span>={'{'}
        ...
        >
          {[
            { n: '01', label: 'click "Inspect" in the slide header', tint: 'var(--of-accent)' },
...
const PresentMode: Page = () => {
  const keys: { k: string; label: string; tint: string }[] = [
    { k: 'F', label: 'enter / exit fullscreen', tint: 'var(--of-accent)' },
  ...
  return (
    <div style={{ ...fill, padding: '120px 100px' }}>
      ...
      <p style={{ fontSize: 30, color: text2, lineHeight: 1.5, margin: 0, maxWidth: 1700 }}>
        ...
        gets out of the way.
        <code style={{ fontFamily: 'var(--of-font-display)', color: mint }}> dist/</code> is a
        ...
        {cmds.map((c, i) => (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 16 }}>
              <span style={{ color: c.tint, fontFamily: 'var(--of-font-display)', fontSize: 26 }}>
                $
              </span>
              <code style={{ fontFamily: 'var(--of-font-display)', fontSize: 30, color: text2 }}>
                {c.cmd}
              </code>
            </div>
      ...
      >
        <span style={{ color: 'var(--of-accent)' }}>›</span> per-slide chunks come for free from{' '}
...
const Closing: Page = () => {
  const recap = [
    { tint: 'var(--of-accent)', title: 'discovery', body: 'fast-glob → 3 virtual modules' },
...
export const meta: FrameMeta = { title: 'Inside open-slide', createdAt: '2026-05-05T17:45:52Z' };
