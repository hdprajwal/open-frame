...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      >
        How <em style={{ fontStyle: 'italic', color: 'var(--of-accent)' }}>LLMs</em>
        <br />
        actually work.
      </h1>
      <div
...
const BigIdea: Page = () => (
  ...
  >
    ...
    <SectionTitle size={120} margin="40px 0 60px" maxWidth={1600}>
      An LLM predicts the <em style={{ color: 'var(--of-accent)' }}>next token</em>,
      <br />
      one token at a time.
    </SectionTitle>
    <p
...
const WhatIsToken: Page = () => (
  ...
  >
    ...
    >
      ...
      >
        <span style={{ fontFamily: fonts.mono, color: 'var(--of-text)' }}>·</span> marks a leading
            ...
            return (
              <div
                ...
                style={{
                  ...
                  height: 40,
                  borderRadius: 3,
                  background: inWin ? 'var(--of-accent)' : palette.line,
                  opacity: inWin ? 1 : 0.7,
        ...
        >
          <div
            style={{
              ...
              fontFamily: 'var(--of-font-display)',
              fontSize: 48,
              color: row.highlight ? 'var(--of-accent)' : palette.faint,
              lineHeight: 1,
              fontWeight: 400,
            }}
          >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 26, color: 'var(--of-text)', lineHeight: 1.3 }}>
              {row.label}
            </div>
            <div
              style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 28 }}>
        {[
          ...
          >
            ...
            <div style={{ fontSize: 22, lineHeight: 1.5, color: 'var(--of-text)' }}>{k.body}</div>
          </div>
        ))}
      </div>
    </div>
  ...
  >
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      >
        Tokens. Attention.
        <br />
        <em style={{ color: 'var(--of-accent)' }}>Predict. Repeat.</em>
      </h2>
      <div
        className="l-line"
        style={{
...
export const meta: FrameMeta = { title: 'How LLMs Work', createdAt: '2026-04-26T21:13:13+08:00' };
export default [
  Cover,
  BigIdea,
  WhatIsToken,
