import { type DesignSystem, type FrameMeta, type Page, Step, Steps } from '@open-frame/core';
      ...
      <Steps>
        ...
        <Step>
          <p style={{ fontSize: 34, lineHeight: 1.5, margin: 0 }}>
            Finally, the turn — the line that re-frames everything above and makes the frame a
...
const Closing: Page = () => (
  ...
  >
    ...
    <div style={{ alignSelf: 'center', maxWidth: 1400 }}>
      ...
      >
        Jumping into this frame via the overview grid shows it fully composed. Stepping in linearly
