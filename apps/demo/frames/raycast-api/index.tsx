...
const Eyebrow = ({ children, delay = 0 }: { children: React.ReactNode; delay?: number }) => (
  ...
  >
    <svg
      ...
      aria-hidden="true"
    >
      <circle cx={16} cy={16} r={14} fill="var(--of-accent)" opacity={0.12} />
      <circle cx={16} cy={16} r={10} fill="var(--of-accent)" opacity={0.22} />
      <circle cx={16} cy={16} r={6} fill="var(--of-accent)" opacity={0.45} />
      <circle cx={16} cy={16} r={4} fill="var(--of-accent)" />
    </svg>
    {children}
  </div>
);
  ...
  <div style={{ position: 'relative', width: 820 }}>
    ...
    >
      ...
      >
        ...
        />
        <div style={{ fontSize: 24, fontWeight: 500, flex: 1, color: 'var(--of-text)' }}>
          {query}
          <span
            className="rc-caret"
            style={{
      ...
      <div>
        <img
          ...
          style={{
            ...
            display: 'block',
            marginBottom: 28,
            filter: `drop-shadow(0 0 28px var(--of-accent))`,
          }}
        />
        ...
        >
          Raycast
          <br />
          <span style={{ color: 'var(--of-accent)' }}>Developer API</span>
        </h1>
        <p
          className="rc-fadeup"
          style={{
  ...
  <div style={fill}>
    ...
    <div style={{ padding: '180px 160px 0' }}>
      ...
      >
        ...
        <br />
        already use <span style={{ color: 'var(--of-accent)' }}>40 times a day.</span>
      </h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 24 }}>
          {items.map((it, i) => (
            ...
            >
              ...
              <div style={{ fontSize: 28, color: 'var(--of-text)', lineHeight: 1.4 }}>
                {it.desc}
              </div>
            </div>
          ))}
    ...
    >
      <div>
        ...
        >
          ActionPanel:
          <br />
          <span style={{ color: 'var(--of-accent)' }}>every action,</span> a shortcut.
        </h2>
        <p
          className="rc-fadeup"
          style={{
  ...
  <div style={fill}>
    ...
    <div style={{ padding: '160px 160px 0' }}>
      ...
      >
        Call any model.
        <br />
        <span style={{ color: 'var(--of-accent)' }}>No keys. No setup.</span>
      </h2>
      <div
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: 8 }}>
            ...
            <span style={{ color: 'var(--of-accent)' }}>ask</span>(
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          {[
            ...
            >
              <div
                style={{ fontSize: 30, fontWeight: 800, color: 'var(--of-accent)', minWidth: 100 }}
              >
                {b.k}
              </div>
              <div style={{ fontSize: 20, color: 'var(--of-text)', lineHeight: 1.4 }}>{b.v}</div>
            </div>
          ))}
        </div>
      </div>
    ...
    >
      <img
        ...
        style={{
          ...
          display: 'block',
          marginBottom: 32,
          filter: `drop-shadow(0 0 36px var(--of-accent))`,
        }}
      />
      ...
      >
        npm i{' '}
        <span style={{ color: 'var(--of-accent)', fontFamily: fonts.mono }}>@raycast/api</span>
      </h1>
      <p
        className="rc-fadeup"
        style={{
      ...
      >
        Or open Raycast → <span style={{ color: 'var(--of-text)' }}>Create Extension</span> → pick a
        template.
        <br />
        Docs at <span style={{ color: 'var(--of-text)' }}>developers.raycast.com</span>
      </p>
    </div>
    <Footer />
  </div>
