...
const Mono = ({ children, accent = false }: { children: React.ReactNode; accent?: boolean }) => (
  <span
    style={{
      ...
      fontSize: '0.82em',
      color: accent ? 'var(--of-accent)' : 'var(--of-text)',
  ...
  >
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      >
        Claude
        <br />
        <em style={{ fontStyle: 'italic', color: 'var(--of-accent)' }}>Code.</em>
      </h1>
      <div
        style={{
          height: 1,
      ...
      <div style={{ display: 'flex', gap: 80, flex: 1 }}>
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          >
            ...
            <div style={{ paddingLeft: 24 }}>
              <span style={{ color: 'var(--of-accent)' }}>"allow"</span>: ["Bash(npm test:*)",
              "Edit"]
            </div>
            <div>{'}'}</div>
          </div>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          >
            ...
            <div style={{ paddingLeft: 24 }}>
              <span style={{ color: 'var(--of-accent)' }}>matcher</span>: "Edit"
            </div>
            <div style={{ paddingLeft: 24 }}>
              <span style={{ color: 'var(--of-accent)' }}>command</span>: "biome format"
            </div>
          </div>
        </div>
      </div>
  ...
  >
    ...
    >
      ...
      >
        One agent.
        <br />
        <em style={{ color: 'var(--of-accent)' }}>Many surfaces.</em>
      </h2>
      <p
        style={{
          fontSize: 'var(--of-size-body)',
  ...
  >
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      >
        ...
        <br />
        <em style={{ color: 'var(--of-accent)' }}>the work</em>, not the prompt.
      </h2>
    ...
    >
      ...
      >
        {transcript.map((line, i) => {
          const styles =
            line.who === 'you'
              ? { color: 'var(--of-text)', fontWeight: 500 }
              : line.who === 'claude'
                ? {
                    color: palette.ink,
                    fontFamily: 'var(--of-font-display)',
