import type { DesignSystem, FrameMeta, Page } from '@open-frame/core';
...
const KEYFRAMES = `
@keyframes of-rise { from { opacity: 0; transform: translateY(40px); } to { opacity: 1; transform: translateY(0); } }
@keyframes of-rise-sm { from { opacity: 0; transform: translateY(18px); } to { opacity: 1; transform: translateY(0); } }
@keyframes of-fade { from { opacity: 0; } to { opacity: 1; } }
@keyframes of-scale-in { from { opacity: 0; transform: scale(0.7); } to { opacity: 1; transform: scale(1); } }
@keyframes of-bar-grow { from { transform: scaleX(0); } to { transform: scaleX(1); } }
@keyframes of-sweep-in { from { transform: translateX(-110%); } to { transform: translateX(0); } }
@keyframes of-fab-drop {
    ...
    >
      ...
      <div
        style={{
          ...
          paddingLeft: 16,
          animation: `of-fade 700ms ${M_EASE} 80ms both`,
        }}
      >
        <div
          style={{
      ...
      <div
        style={{
          ...
          display: 'flex',
          flexDirection: 'column',
          animation: `of-rise 900ms ${M_EASE} 200ms both`,
        }}
      >
        {/* App bar */}
        <div
          style={{
            ...
            animation: `of-bar-grow 700ms ${M_EASE} 360ms both`,
          }}
        >
        ...
        <div style={{ flex: 1, display: 'flex' }}>
          ...
          <div
            style={{
              ...
              display: 'flex',
              flexDirection: 'column',
              animation: `of-sweep-in 700ms ${M_EASE} 700ms both`,
            }}
          >
            <div
              style={{
            ...
            {drawerItems.map((label, i) => (
              <div
                ...
                style={{
                  ...
                  color: i === 0 ? 'var(--of-accent)' : ink.muted,
                  background: i === 0 ? 'rgba(63,81,181,0.08)' : 'transparent',
                  animation: `of-rise-sm 500ms ${M_EASE} ${1000 + i * 70}ms both`,
                }}
              >
                {label}
              </div>
            ...
            {mailItems.map((m, i) => (
              <div
                ...
                style={{
                  ...
                  padding: '24px 32px',
                  borderBottom: `1px solid ${ink.divider}`,
                  animation: `of-rise-sm 600ms ${M_EASE} ${1100 + i * 90}ms both`,
                }}
              >
                <div
                  style={{
        ...
        <div
          style={{
            ...
            alignItems: 'center',
            justifyContent: 'center',
            animation: `of-fab-drop 1000ms ${M_OVERSHOOT} 1700ms both, of-fab-ripple 2400ms ${M_EASE} 2900ms infinite`,
          }}
        >
          ✎
        </div>
...
const Elevation: Page = () => {
  ...
  return (
    ...
    >
      <Keyframes />
      <div style={{ ...eyebrow, animation: `of-fade 600ms ${M_EASE} 80ms both` }}>Elevation</div>
      <h2
        style={{
          fontFamily: 'var(--of-font-display)',
          fontSize: 88,
          ...
          margin: '24px 0 16px',
          letterSpacing: '-0.02em',
          animation: `of-rise 800ms ${M_EASE} 180ms both`,
        }}
      >
        z-axis, in <span style={{ color: 'var(--of-accent)' }}>dp</span>.
      </h2>
      <div
        style={{
          fontSize: 26,
          color: ink.muted,
          marginBottom: 80,
          animation: `of-rise 700ms ${M_EASE} 320ms both`,
        }}
      >
            ...
            >
              <div
                style={{
                  ...
                  fontWeight: 300,
                  color: 'var(--of-accent)',
                  animation: `of-elev-rise 900ms ${M_EASE} ${500 + i * 140}ms both`,
                }}
              >
                {dp}
              </div>
...
const Color: Page = () => {
  ...
  const swatchRow = (
    ...
    <div
      ...
      style={{
        ...
        fontWeight: 500,
        position: 'relative',
        animation: `of-rise-sm 500ms ${M_EASE} ${delayBase + i * 50}ms both`,
      }}
    >
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div style={{ ...eyebrow, animation: `of-fade 600ms ${M_EASE} 80ms both` }}>
            Color · 2014
          </div>
          <h2
            style={{
          ...
          >
            <span style={{ color: 'var(--of-accent)' }}>500</span> primary,{' '}
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div
            style={{
              ...
              color: ink.muted,
              lineHeight: 1.5,
              animation: `of-fade 700ms ${M_EASE} 1100ms both`,
            }}
          >
            ...
            {families.map((f, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 4,
                  boxShadow: ELEV[1],
                  animation: `of-scale-in 500ms ${M_OVERSHOOT} ${500 + i * 70}ms both`,
                }}
              >
                {f.title}
              </div>
        ...
        {scale.map((s, i) => (
          <div
            ...
            style={{
              ...
              borderBottom: `1px solid ${ink.divider}`,
              paddingBottom: 16,
              animation: `of-rise-sm 600ms ${M_EASE} ${380 + i * 110}ms both`,
            }}
          >
            <div
              style={{
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            textAlign: 'right',
            lineHeight: 1.4,
            animation: `of-fade 800ms ${M_EASE} 380ms both`,
          }}
        >
      ...
      <div
        style={{
          ...
          position: 'relative',
          overflow: 'hidden',
          animation: `of-rise 800ms ${M_EASE} 320ms both`,
        }}
      >
          ...
          <div key={i} style={{ position: 'absolute', left: `${t.x}%`, top: `${t.y}%` }}>
            ...
            <div
              style={{
                ...
                borderRadius: '50%',
                background: t.color,
                animation: `of-touch-ripple 4500ms ${M_EASE} ${t.delay}ms infinite`,
              }}
            />
          </div>
        ))}
...
const Components: Page = () => {
  ...
  return (
    ...
    >
      <Keyframes />
      <div style={{ ...eyebrow, animation: `of-fade 600ms ${M_EASE} 80ms both` }}>Components</div>
      <h2
        style={{
          fontFamily: 'var(--of-font-display)',
          fontSize: 72,
      ...
      >
        {/* Switch */}
        <div style={{ ...cellStyle, animation: `of-rise 700ms ${M_EASE} 320ms both`, gap: 24 }}>
          ...
          >
            <div
              style={{
                ...
                borderRadius: 12,
                position: 'relative',
                animation: `of-switch-track 2400ms ${M_EASE} infinite`,
            ...
            >
              <div
                style={{
                  ...
                  background: '#fafafa',
                  boxShadow: ELEV[2],
                  animation: `of-switch-on 2400ms ${M_EASE} infinite`,
                }}
              />
            </div>
            <div style={{ fontSize: 22, color: 'var(--of-text)', fontWeight: 500 }}>Wi-Fi</div>
          </div>
        </div>

        {/* Slider */}
        <div style={{ ...cellStyle, animation: `of-rise 700ms ${M_EASE} 420ms both`, gap: 24 }}>
            ...
            >
              <div
                style={{
                  ...
                  background: 'var(--of-accent)',
                  boxShadow: ELEV[2],
                  animation: `of-slider 6000ms ${M_EASE} infinite`,
                }}
              />
            </div>
          </div>
        ...
        {/* Checkbox */}
        <div style={{ ...cellStyle, animation: `of-rise 700ms ${M_EASE} 520ms both`, gap: 24 }}>
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" style={{ overflow: 'visible' }}>
                ...
                <polyline
                  ...
                  style={{
                    strokeDasharray: 24,
                    animation: `of-checkbox-in 600ms ${M_EASE} 1100ms both`,
                  }}
                />
              </svg>
            </div>
        ...
        {/* Raised button */}
        <div style={{ ...cellStyle, animation: `of-rise 700ms ${M_EASE} 620ms both`, gap: 24 }}>
        ...
        {/* Chip */}
        <div style={{ ...cellStyle, animation: `of-rise 700ms ${M_EASE} 720ms both`, gap: 24 }}>
          ...
          >
            {[
              ...
              { name: 'R', label: 'Roboto', bg: 'var(--of-accent)' },
        ...
        <div
          style={{
            ...cellStyle,
            animation: `of-rise 700ms ${M_EASE} 820ms both`,
            position: 'relative',
            overflow: 'hidden',
            gap: 24,
          }}
          ...
          >
            <div
              style={{
                ...
                padding: '0 20px',
                fontSize: 15,
                animation: `of-snackbar-in 5000ms ${M_EASE} 1500ms infinite`,
              }}
            >
  ...
  >
    ...
    <div
      style={{
        ...
        background: 'var(--of-accent)',
        opacity: 0,
        animation: `of-fade 1200ms ${M_EASE} 200ms forwards`,
    ...
    <div style={{ ...eyebrow, animation: `of-fade 600ms ${M_EASE} 100ms both` }}>
      A decade later
    </div>
    <h2
      style={{
        ...
        lineHeight: 0.95,
        letterSpacing: '-0.04em',
        animation: `of-rise 900ms ${M_EASE} 220ms both`,
      }}
    >
      Material.
    </h2>
    ...
    <div
      style={{
        ...
        animation: `of-rise 800ms ${M_EASE} 600ms both`,
      }}
    >
      <div
        style={{
          ...
          color: '#fff',
          overflow: 'hidden',
          animation: `of-fab-morph 5000ms ${M_EASE} 1200ms infinite both`,
          willChange: 'width',
        }}
      >
        <span
          style={{
            ...
            animation: `of-fab-plus 5000ms ${M_EASE} 1200ms infinite both`,
          }}
        >
          +
        </span>
        <span
          style={{
            ...
            textAlign: 'center',
            transform: 'translateY(-50%)',
            animation: `of-fab-label 5000ms ${M_EASE} 1200ms infinite both`,
          }}
        >
    ...
    <p
      style={{
        ...
        maxWidth: 1200,
        margin: '40px 0 0',
        animation: `of-fade 800ms ${M_EASE} 1100ms both`,
      }}
    >
