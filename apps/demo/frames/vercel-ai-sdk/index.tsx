...
const Cover: Page = () => (
  ...
  >
    ...
    >
      <span
        style={{
          ...
          boxShadow: '0 0 24px var(--of-accent)',
    ...
    >
      Vercel <span style={{ color: 'var(--of-accent)' }}>AI&nbsp;SDK</span>
    </h1>
    ...
    >
      ...
      <span style={{ color: 'var(--of-text)', fontWeight: 500 }}>one API, any model.</span>
    </p>
...
const Problem: Page = () => (
  <div style={{ ...fill, padding: 120, display: 'flex', flexDirection: 'column' }}>
    ...
    >
      <span style={{ color: 'var(--of-accent)' }}>01</span>
...
const Pitch: Page = () => (
  ...
  >
    ...
    >
      <span style={{ color: 'var(--of-accent)' }}>02</span>
      <span style={{ color: palette.dim, margin: '0 14px' }}>·</span>
      The idea
    </div>
    ...
    >
      One <span style={{ color: 'var(--of-accent)' }}>API.</span>
      <br />
      Any model.
    </h2>
...
const Code: Page = () => (
  <div style={{ ...fill, padding: 120, display: 'flex', flexDirection: 'column' }}>
    ...
    >
      <span style={{ color: 'var(--of-accent)' }}>03</span>
      <span style={{ color: palette.dim, margin: '0 14px' }}>·</span>
      Looks like this
    </div>
...
const Layers: Page = () => (
  <div style={{ ...fill, padding: 120, display: 'flex', flexDirection: 'column' }}>
    ...
    >
      <span style={{ color: 'var(--of-accent)' }}>04</span>
      <span style={{ color: palette.dim, margin: '0 14px' }}>·</span>
      Architecture
    </div>
...
const Capabilities: Page = () => (
  <div style={{ ...fill, padding: 120, display: 'flex', flexDirection: 'column' }}>
    ...
    >
      <span style={{ color: 'var(--of-accent)' }}>05</span>
      <span style={{ color: palette.dim, margin: '0 14px' }}>·</span>
      Capabilities
    </div>
...
const Providers: Page = () => (
  <div style={{ ...fill, padding: 120, display: 'flex', flexDirection: 'column' }}>
    ...
    >
      <span style={{ color: 'var(--of-accent)' }}>06</span>
      <span style={{ color: palette.dim, margin: '0 14px' }}>·</span>
      Providers
    </div>
    ...
    >
      ...
      >
        Plug in <span style={{ color: 'var(--of-accent)' }}>any</span> provider.
      </h2>
      <span
        style={{
          fontFamily: font.mono,
      ...
      {providers.map((p, i) => (
        <div
          ...
          style={{
            ...
            fontSize: 28,
            fontWeight: 500,
            color: p === '+ more' ? 'var(--of-accent)' : palette.textSoft,
            textAlign: 'center',
...
const Closing: Page = () => (
  ...
  >
    ...
    >
      Build with <span style={{ color: 'var(--of-accent)' }}>AI.</span>
    </h2>
    ...
    >
      <span
        style={{
          ...
          borderRadius: '50%',
          background: 'var(--of-accent)',
          boxShadow: '0 0 16px var(--of-accent)',
        }}
      />
      ai-sdk.dev/docs
    </div>
...
export const meta: FrameMeta = { title: 'Vercel AI SDK', createdAt: '2026-05-03T23:14:26+08:00' };
export default [
  Cover,
  Problem,
  Pitch,
