import type { DesignSystem, FrameMeta, FrameTransition, Page } from '@open-frame/core';
  ...
  >
    ...
    <div style={{ alignSelf: 'center' }}>
      ...
      >
        Introducing
        <br />
        <span style={{ color: 'var(--of-accent)' }}>Transition</span>
        <span style={{ color: 'var(--of-accent)' }}>.</span>
      </h1>
      <p
        style={{
          fontSize: 28,
...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ alignSelf: 'center' }}>
      ...
      >
        Maximal<span style={{ color: 'var(--of-accent)' }}>.</span>
      </h1>
      <p
        style={{
          fontSize: 30,
...
const FlipGlyph = (
  <svg width="220" height="160" viewBox="0 0 220 160" fill="none" aria-hidden>
    ...
    />
    <line x1="94" y1="8" x2="94" y2="152" stroke="var(--of-text)" strokeWidth="1" opacity="0.4" />
  </svg>
);
...
const ShearGlyph = (
  <svg width="220" height="140" viewBox="0 0 220 140" fill="none" aria-hidden>
    <path d="M16 30 L160 18 L196 110 L52 122 Z" stroke="var(--of-accent)" strokeWidth="2" />
...
const PortalGlyph = (
  <svg width="180" height="180" viewBox="0 0 180 180" fill="none" aria-hidden>
    ...
    <path d="M90 14 A 76 76 0 0 1 166 90" stroke="var(--of-accent)" strokeWidth="3" fill="none" />
    <path d="M90 90 L 138 38" stroke="var(--of-text)" strokeWidth="1.5" opacity="0.7" />
    <circle cx="90" cy="90" r="4" fill="var(--of-accent)" />
  </svg>
);
...
const Closing: Page = () => (
  ...
  >
    ...
    <div style={{ alignSelf: 'center', maxWidth: 1500 }}>
      ...
      >
        All possible<span style={{ color: 'var(--of-accent)' }}>.</span>
        <br />
  ...
  >
    ...
    <div style={{ alignSelf: 'center' }}>
      ...
      >
        ...
        npx <span style={{ color: 'var(--of-accent)' }}>@open-frame/cli</span> init
      </div>
      <p
        style={{
          fontSize: 26,
