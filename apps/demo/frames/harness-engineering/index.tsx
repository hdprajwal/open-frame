 ...
 * `var(--of-*)` so the Design panel can update them live; everything else
...
const Footer = ({ section }: { section?: string }) => {
  ...
  return (
    ...
    >
      <span>
        <span style={{ color: 'var(--of-accent)' }}>●</span> {section ?? 'main'} ·{' '}
...
const Cover: Page = () => (
  ...
  >
    ...
    >
      ...
      >
        <span style={{ color: 'var(--of-accent)', textShadow: '0 0 22px rgba(57,255,136,0.6)' }}>
          ${' '}
        </span>
        harness
      </span>
...
const ShiftColumn = ({
  ...
  <div
    ...
    style={{
      ...
      border: `1px solid ${tone === 'bright' ? 'var(--of-accent)' : tokens.color.line}`,
  ...
  >
    <div
      style={{
        fontSize: 22,
        color: tone === 'bright' ? 'var(--of-accent)' : tokens.color.muted,
    ...
    <ul style={{ margin: 0, padding: 0, listStyle: 'none' }}>
      {bullets.map((b) => (
        ...
        >
          <span
            style={{
              color: tone === 'bright' ? 'var(--of-accent)' : tokens.color.faint,
              marginRight: 14,
            }}
          >
            ›
...
const Shift: Page = () => (
  ...
  >
    ...
    >
      the model is no longer <span style={{ color: 'var(--of-accent)' }}>the bottleneck.</span>
    </h2>
    ...
    <div
      ...
      style={{
        ...
        marginTop: 40,
        padding: '20px 28px',
        borderLeft: `2px solid var(--of-accent)`,
        background: 'rgba(57,255,136,0.05)',
      }}
    >
      <div style={{ fontSize: 26, lineHeight: 1.5, color: 'var(--of-text)', fontStyle: 'italic' }}>
...
const Definition: Page = () => (
  ...
  >
    ...
    >
      an <span style={{ color: 'var(--of-accent)' }}>agent harness</span> is{' '}
...
const Annotation = ({ label, body, delay }: { label: string; body: string; delay: number }) => (
  ...
  >
    <div style={{ fontSize: 20, color: 'var(--of-accent)', letterSpacing: '0.16em' }}>{label}</div>
...
const ClaudeCodeExample: Page = () => (
  ...
  >
    ...
    >
      <span style={{ color: 'var(--of-accent)' }}>claude code</span> is a harness.
    </h2>
    <p
      className="h-fadeup"
      style={{
    ...
    <div style={{ display: 'flex', gap: 50, flex: 1 }}>
      ...
      >
        ...
        >
          ...
          <span style={{ color: 'var(--of-accent)' }}>● connected</span>
        </div>
        <div style={{ color: tokens.color.muted }}>
          <span style={{ color: 'var(--of-accent)' }}>›</span> tools{' '}
        ...
        <div style={{ color: tokens.color.muted, marginTop: 8 }}>
          <span style={{ color: 'var(--of-accent)' }}>›</span> loop
        </div>
        <div style={{ color: 'var(--of-text)', paddingLeft: 22 }}>
          think → call tool → read result → decide → repeat
        </div>
        <div style={{ color: tokens.color.muted, marginTop: 8 }}>
          <span style={{ color: 'var(--of-accent)' }}>›</span> state
        </div>
        <div style={{ color: 'var(--of-text)', paddingLeft: 22 }}>
          TodoWrite · plan files · CLAUDE.md · git commits
        </div>
        <div style={{ color: tokens.color.muted, marginTop: 8 }}>
          <span style={{ color: 'var(--of-accent)' }}>›</span> approval
        </div>
        ...
        return (
          <div
            ...
            style={{
              ...
              border: `1px solid ${l.tone === 'bright' ? 'var(--of-accent)' : tokens.color.line}`,
          ...
          >
            ...
            <div style={{ flex: 1, fontSize: 'var(--of-size-body)', color: 'var(--of-text)' }}>
              {l.artifact}
            </div>
            <div style={{ flex: 1, fontSize: 'var(--of-size-body)', color: tokens.color.muted }}>
              {l.scope}
            </div>
          </div>
        );
  ...
  >
    ...
    >
      ...
      >
        ...
        <span style={{ color: 'var(--of-accent)', textShadow: '0 0 22px rgba(57,255,136,0.5)' }}>
          the product.
        </span>
        <Cursor size="0.5em" height="0.85em" />
      </span>
    ...
    >
      {sources.map((s, i) => (
        ...
        >
          <span style={{ color: 'var(--of-accent)', minWidth: 32 }}>›</span>
          <span style={{ color: tokens.color.accent2, minWidth: 240 }}>{s.who}</span>
          <span style={{ flex: 1, color: 'var(--of-text)' }}>{s.what}</span>
