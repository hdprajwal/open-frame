...
// data-of-step="revealed", so the entrance keyframe fires on reveal rather
...
[data-of-step="revealed"] .m-rise     { animation: mRise 680ms ${EASE} both; }
[data-of-step="revealed"] .m-left     { animation: mLeft 640ms ${EASE} both; }
[data-of-step="revealed"] .m-right    { animation: mRight 640ms ${EASE} both; }
[data-of-step="revealed"] .m-pop      { animation: mPop 620ms ${OVERSHOOT} both; }
[data-of-step="revealed"] .m-pop-late { animation: mPop 560ms ${OVERSHOOT} 820ms both; }
[data-of-step="revealed"] .m-blur     { animation: mBlur 760ms ${EASE} both; }
[data-of-step="revealed"] .m-flip     { animation: mFlip 720ms ${OVERSHOOT} both; transform-origin: top center; backface-visibility: hidden; }
[data-of-step="revealed"] .m-wipe     { animation: mWipe 720ms ${EASE} both; }
[data-of-step="revealed"] .m-bar      { animation: mBar 820ms ${OVERSHOOT} both; transform-origin: bottom center; }
[data-of-step="revealed"] .m-draw     { animation: mDraw 1100ms ${EASE} both; }
[data-of-step="revealed"] .m-dash     { animation: mDash 600ms ${EASE} both; transform-origin: left center; }
[data-of-step="revealed"] .m-count    { animation: mCount 1200ms ${EASE} both; }
[data-of-step="revealed"] .m-sweep    { animation: mSweep 620ms ${EASE} both; }

[data-of-step="revealed"] .m-grid > * { animation: mTile 560ms ${OVERSHOOT} both; }
[data-of-step="revealed"] .m-grid > *:nth-child(1)  { animation-delay: 0ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(2)  { animation-delay: 50ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(3)  { animation-delay: 100ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(4)  { animation-delay: 150ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(5)  { animation-delay: 80ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(6)  { animation-delay: 130ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(7)  { animation-delay: 180ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(8)  { animation-delay: 230ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(9)  { animation-delay: 160ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(10) { animation-delay: 210ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(11) { animation-delay: 260ms; }
[data-of-step="revealed"] .m-grid > *:nth-child(12) { animation-delay: 310ms; }
...
/* During a page change the framework remounts the OUTGOING page fully
   ...
   keyed on data-of-step="revealed", they would replay on that exiting copy.
...
.absolute.inset-0:first-child:not(:last-child) [data-of-step] * {
  animation: none !important;
}

@media (prefers-reduced-motion: reduce) {
  [data-of-step] * { animation-duration: 1ms !important; animation-delay: 0ms !important; }
}
`;
  ...
  <div style={fill}>
    ...
    <div style={{ alignSelf: 'center' }}>
      ...
      >
        Steps,
        <br />
        <span style={{ color: 'var(--of-accent)' }}>in motion.</span>
      </h1>
...
const SlideRow = ({
  ...
  >
    ...
    >
      <span style={{ fontFamily: mono, fontSize: 22, color: 'var(--of-accent)' }}>{label}</span>
      <span>{children}</span>
    </div>
  </div>
);
...
const PopCard = ({ k, title, body }: { k: string; title: string; body: string }) => (
  <div className="m-pop" style={POP_CARD}>
    <div style={{ fontFamily: mono, fontSize: 22, color: 'var(--of-accent)' }}>{k}</div>
  ...
  <div style={fill}>
    ...
    >
      <Steps>
        <Step>
          <BlurLine>
            First, <span style={{ color: 'var(--of-accent)' }}>out of focus.</span>
          </BlurLine>
        </Step>
        <Step>
...
const FlipCard = ({ k, title, body }: { k: string; title: string; body: string }) => (
  <div style={{ perspective: 1200 }}>
    <div className="m-flip" style={FLIP_CARD}>
      <div style={{ fontFamily: mono, fontSize: 60, fontWeight: 800, color: 'var(--of-accent)' }}>
        {k}
      </div>
  ...
  <div style={fill}>
    ...
    <div style={{ alignSelf: 'center' }}>
      <Steps>
        ...
        <Step>
          <WipeLine color="var(--of-accent)">edge to edge,</WipeLine>
        </Step>
        <Step>
...
const Connector = () => (
  <div
    ...
    style={{
      width: 90,
      height: 3,
      background: `linear-gradient(90deg, var(--of-accent), ${accentSoft})`,
    }}
  />
);

const Node = ({ title, sub, accent }: { title: string; sub: string; accent?: boolean }) => (
  <div className="m-pop" style={{ ...NODE, borderColor: accent ? 'var(--of-accent)' : hairline }}>
    <div style={{ color: accent ? 'var(--of-accent)' : 'var(--of-text)' }}>{title}</div>
  ...
  <div style={fill}>
    ...
    <div style={{ alignSelf: 'center', width: '100%' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
        <Steps>
          <Step>
            <Node title="Source" sub="frames/*.tsx" />
          </Step>
          <Step>
            <Connector />
          </Step>
...
const Closing: Page = () => (
  <div style={fill}>
    ...
    <div style={{ alignSelf: 'center', maxWidth: 1500 }}>
      ...
      >
        Motion is <span style={{ color: 'var(--of-accent)' }}>meaning</span>,
        <br />
        not garnish.
      </h2>
      <p
      ...
      >
        ...
        <code style={{ fontFamily: mono, color: 'var(--of-accent)' }}>&lt;Step&gt;</code> wraps
        content; a single attribute — <code style={{ fontFamily: mono }}>data-of-step</code> — lets
