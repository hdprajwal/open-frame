  ...
  >
    ...
    <defs>
      ...
      <radialGradient id="vignette" cx="50%" cy="50%" r="60%">
        <stop offset="0%" stopColor={'var(--of-bg)'} stopOpacity="0" />
        <stop offset="100%" stopColor={'var(--of-bg)'} stopOpacity="1" />
      </radialGradient>
    </defs>
...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      >
        How <em style={{ fontStyle: 'italic', color: 'var(--of-accent)' }}>SSH</em>
        <br />
        actually works.
      </h1>
      <div
...
const WhatIs: Page = () => (
  ...
  >
    ...
    >
      Secure Shell is a <em style={{ color: 'var(--of-accent)' }}>protocol</em> — not a program —
    ...
    <div style={{ display: 'flex', gap: 80, marginTop: 80 }}>
      {[
        ...
        >
          ...
          <div style={{ height: 1, width: 64, background: 'var(--of-text)', margin: '20px 0' }} />
          <div style={{ fontSize: 30, lineHeight: 1.5, color: 'var(--of-text)', fontWeight: 300 }}>
            {it.body}
          </div>
        </div>
      ))}
  ...
  >
    ...
    >
      ...
      <div style={{ width: 140, textAlign: 'center', flexShrink: 0 }}>
        ...
        <div style={{ fontFamily: fonts.mono, fontSize: 36, color: 'var(--of-text)' }}>◐</div>
      </div>
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div
        ...
        style={{
          ...
          [isRight ? 'borderLeft' : 'borderRight']: `16px solid ${'var(--of-text)'}`,
        }}
      />
      {/* label */}
      <div
      ...
      >
        ...
        <div style={{ fontFamily: fonts.mono, fontSize: 30, lineHeight: 1.7 }}>
          <div className="s-faderight" style={{ animationDelay: '900ms', color: palette.muted }}>
            private: <span style={{ color: 'var(--of-text)' }}>a</span>
          </div>
          <div className="s-faderight" style={{ animationDelay: '1100ms', color: palette.muted }}>
            sends:&nbsp;&nbsp;&nbsp;
            <span style={{ color: 'var(--of-accent)' }}>
              g<sup>a</sup>
            </span>
          </div>
          ...
          >
            ...
            <br />
            <span style={{ fontSize: 36, color: 'var(--of-accent)', fontWeight: 600 }}>
      ...
      >
        ...
        <div style={{ fontFamily: fonts.mono, fontSize: 30, lineHeight: 1.7, textAlign: 'right' }}>
          <div className="s-faderight" style={{ animationDelay: '1000ms', color: palette.muted }}>
            <span style={{ color: 'var(--of-text)' }}>b</span> :private
          </div>
  ...
  >
    ...
    <div style={{ display: 'flex', gap: 80, alignItems: 'stretch', flex: 1 }}>
      ...
      >
        ...
        >
          sig = <span style={{ color: 'var(--of-accent)' }}>sign</span>(transcript,{' '}
      ...
      >
        <div className="s-fade" style={{ animationDelay: '900ms' }}>
          <div className="s-float" style={{ fontSize: 64, color: 'var(--of-accent)' }}>
            →
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <span style={{ color: 'var(--of-accent)' }}>verify</span>(sig, transcript,{' '}
          <span style={{ color: 'var(--of-text)' }}>host_pub</span>)
        </div>
        <div
          className="s-scale"
          style={{
        ...
        >
          <span style={{ fontSize: 28, color: 'var(--of-accent)', fontWeight: 600 }}>✓</span>
          <span style={{ fontFamily: fonts.mono, fontSize: 24, color: 'var(--of-text)' }}>
            fingerprint matches
          </span>
        </div>
        <div
...
const UserAuth: Page = () => (
  ...
  >
    ...
    >
      Now you prove who <em style={{ color: 'var(--of-accent)' }}>you</em> are.
    </h2>
      ...
      {[
        ...
        <div
          ...
          style={{
            ...
            border: `1px solid ${row.highlight ? 'var(--of-accent)' : palette.line}`,
            borderRadius: 14,
          }}
        >
          <div
            style={{
              ...
              height: 56,
              borderRadius: '50%',
              border: `1.5px solid ${row.highlight ? 'var(--of-accent)' : 'var(--of-text)'}`,
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              fontFamily: 'var(--of-font-display)',
              fontSize: 30,
              color: row.highlight ? 'var(--of-accent)' : 'var(--of-text)',
              fontWeight: 400,
            }}
          >
            {row.step}
          ...
          <div style={{ flex: 1 }}>
            <div
              style={{ fontSize: 30, fontWeight: 400, color: 'var(--of-text)', lineHeight: 1.4 }}
            >
              {row.label}
            </div>
            {row.mono && (
  ...
  >
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      >
        TCP. Keys.
        <br />
        <em style={{ color: 'var(--of-accent)' }}>Trust. Talk.</em>
      </h2>
      <div
        className="s-line"
        style={{
...
export const meta: FrameMeta = { title: 'How SSH Works', createdAt: '2026-04-26T19:40:46+08:00' };
export default [
  Cover,
  WhatIs,
  Problem,
