...
Start the dev server and open the frame you want to work on. Use it the way
...
*"this frame feels cramped"* — the agent already knows which frame you're
on and which element you've picked. No need to say *"frame 3, the H1 on
the left"*.
