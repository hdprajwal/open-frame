...
1. Scans the workspace for `@frame-comment` markers.
...
```text
› /apply-comments
✓ 3 markers · frames/q2-launch/index.tsx
✓ 1 marker  · frames/intro/index.tsx
```

## Marker semantics

A `@frame-comment` marker is a normal JSX/JS comment that the inspector
