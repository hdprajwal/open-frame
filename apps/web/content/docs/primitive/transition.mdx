...
is no default animation: pages snap unless the frame exports a transition or an
...
- `export const transition` in the frame module sets the frame default.
...
Most frames should keep a single restrained motion family: short duration,
