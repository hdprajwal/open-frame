---
title: Page
description: The component contract for one 1920 × 1080 frame page.
---

`Page` is the base primitive in open-frame. A deck is just an ordered array of
...
const coverTransition: FrameTransition = {
  duration: 240,
  enter: {
    keyframes: [
