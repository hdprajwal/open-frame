...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-5 sm:px-8 pt-16 sm:pt-24 lg:pt-28 pb-12 sm:pb-22">
        <div className="flex flex-col items-center text-center gap-6">
          <span className="caption">Open source</span>
          <h1 className="text-balance text-36 sm:text-44 lg:text-52 font-light tracking-tight leading-1.1">
            The content studio built for agents.
          </h1>

          <p className="max-w-xl text-16 leading-normal text-body">
