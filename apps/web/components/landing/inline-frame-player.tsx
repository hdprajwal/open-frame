...
import demoFrames from './demo-frame';

const CANVAS_W = 1920;
const CANVAS_H = 1080;

export const inlineFrameCount = demoFrames.length;
...
export function InlineFramePlayer({ index, onIndexChange }: Props) {
  ...
  return (
    <div
      ref={rootRef}
      onKeyDown={onKeyDown}
      aria-roledescription="frame player"
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-3 right-3 font-mono text-12 tracking-8 uppercase text-white/80 bg-black/60 backdrop-blur-sm px-2 py-1 rounded-8"
      >
