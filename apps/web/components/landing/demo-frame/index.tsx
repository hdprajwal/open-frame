...
type FrameMeta = { title?: string; theme?: 'light' | 'dark' };

// Vite returns a URL string for asset imports; Next.js/Turbopack returns an
// object like { src, width, height }. Normalize to a string so the frame
...
const Init: Page = () => {
  const stream = [
    '',
    'Created open-frame workspace in /Users/you/my-frame',
    '',
    'Next steps:',
    '  cd my-frame',
    ...
    '  pnpm dev',
    '',
    'Then open the dev server and start authoring in frames/<your-frame>/.',
  ];
  return (
    <div style={fill}>
      <Styles />
    ...
    <div style={fill}>
      ...
      >
        <div className="es-fadeUp">
          ...
          >
            Zero layouts. Zero frame types. Zero templates. Each page is just a React component on a
...
const Loaded: Page = () => {
  const features = [
    ...
    },
    {
      n: '06',
      title: 'Agent skills',
      caption: 'create-frame, apply-comments, create-theme — bundled.',
    },
  ];
  return (
    <div style={fill}>
