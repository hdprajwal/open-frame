...
export const zhTW: Locale = {
  ...
  home: {
    ...
    assets: '素材',
    folders: '資料夾',
    frameCount: { one: '{count} 個畫框', other: '{count} 個畫框' },
    pageCount: { one: '{count} 頁', other: '{count} 頁' },
    themeCount: { one: '{count} 個主題', other: '{count} 個主題' },
    newFolder: '新增資料夾',
    folderName: '資料夾名稱',
    updateAvailable: 'open-frame {version} 已發布，請更新套件以取得最新版本。',
    updatePackage: '更新',
    updatingPackage: '更新中',
    ...
    sortByTitleDesc: 'Z–A',
    noMatches: '沒有相符結果',
    nothingMatchesPrefix: '沒有相符 ',
    nothingMatchesSuffix: ' 的項目。',
    noFramesYet: '尚無畫框',
    createFrameHintPrefix: '在 agent 中執行 ',
    createFrameHintSuffix: ' 開始建立。',
    folderEmptyTitle: '{name} 為空',
    folderEmptyHint: '從側邊欄將畫框從草稿拖入此資料夾。',
    frameActions: '畫框操作',
    moveToFolder: '移至資料夾…',
    renameDialogEyebrow: '重新命名',
    renameDialogTitle: '重新命名畫框',
    renameDialogDescription: '為這份畫框設定新的顯示名稱。',
    frameNamePlaceholder: '畫框名稱',
    moveDialogEyebrow: '移動',
    moveDialogTitle: '移動畫框',
    moveDialogDescriptionPrefix: '為 ',
    moveDialogDescriptionSuffix: ' 選擇資料夾。',
    deleteDialogEyebrow: '危險操作',
    deleteDialogTitle: '刪除畫框？',
    ...
    toastFrameDuplicated: '已將「{frame}」複製為 {newFrame}',
    toastFrameDuplicateFailed: '無法複製畫框',
    toastFrameMoved: '已將「{frame}」移至 {folder}',
    toastFrameMoveFailed: '移動畫框失敗',
  ...
  presenter: {
    ...
    endOfDeck: '簡報結束',
    speakerNotes: '演講備忘',
    noNotesPrefix: '此畫框沒有演講備忘。在你的畫框模組中加入 ',
  ...
  present: {
    ...
    overviewDialogAria: '畫框總覽',
    overviewEyebrow: '總覽',
    overviewGoToAria: '前往第 {n} 張畫框',
    nowBadge: '目前',
  },
  ...
  inspector: {
    ...
    pickerLoading: '載入中…',
    pickerEmpty: '此畫框的素材資料夾尚未有圖片。請從「素材」分頁加入。',
    ...
    commentsEmpty: '尚無留言。開啟「檢視」並點選畫框元素。',
  ...
  asset: {
    ...
    deleteAssetDescription: '要刪除 {name} 嗎?畫框中引用此檔案的匯入將失效。',
    deleteAssetInUseDescription: '{name} 在 {frames} 個畫框中被使用了 {count} 次。',
    deleteAssetInUseHint: '刪除後這些使用處會自動還原為圖片占位符。',
    deleteAndRevert: '刪除並還原',
    toastRevertFailed: '無法還原 {frameId} 中的使用',
  ...
  themes: {
    ...
    noThemesHintSuffix: ' 來建立一個 — 一個位於 themes/ 的 markdown 檔案，加上同名的 demo frame。',
    noDemoYet: '尚無 demo',
    noDemoHintPrefix: '對此主題重新執行 ',
    noDemoHintSuffix: ' 即可產生預覽用的 frame。',
    backToGallery: '返回主題列表',
    pageOf: '第 {n}/{total} 頁',
    nextPageAria: '下一頁',
    prevPageAria: '上一頁',
    usedBy: '使用此主題的 frames',
    usedByEmpty: '尚未有 frames 使用此主題。',
