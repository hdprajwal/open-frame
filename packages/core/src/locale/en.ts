...
export const en: Locale = {
  ...
  home: {
    ...
    assets: 'Assets',
    folders: 'Folders',
    frameCount: { one: '{count} frame', other: '{count} frames' },
    pageCount: { one: '{count} page', other: '{count} pages' },
    themeCount: { one: '{count} theme', other: '{count} themes' },
    ...
    nothingMatchesSuffix: '.',
    noFramesYet: 'No frames yet',
    createFrameHintPrefix: 'Run ',
    createFrameHintSuffix: ' in your agent to scaffold one.',
    folderEmptyTitle: '{name} is empty',
    folderEmptyHint: 'Drag a frame from Draft into this folder in the sidebar.',
    frameActions: 'Frame actions',
    moveToFolder: 'Move to folder…',
    renameDialogEyebrow: 'Rename',
    renameDialogTitle: 'Rename frame',
    renameDialogDescription: 'Give this frame a new display name.',
    frameNamePlaceholder: 'Frame name',
    moveDialogEyebrow: 'Move',
    moveDialogTitle: 'Move frame',
    moveDialogDescriptionPrefix: 'Choose a folder for ',
    moveDialogDescriptionSuffix: '.',
    deleteDialogEyebrow: 'Destructive',
    deleteDialogTitle: 'Delete frame?',
    ...
    toastFrameDuplicated: 'Duplicated “{frame}” as {newFrame}',
    toastFrameDuplicateFailed: 'Could not duplicate frame',
    toastFrameMoved: 'Moved “{frame}” to {folder}',
    toastFrameMoveFailed: 'Failed to move frame',
  ...
  presenter: {
    ...
    noNotesPrefix: 'No speaker notes for this frame. Add ',
    noNotesSuffix: ' to your frame module to see notes here.',
    ...
    elapsed: 'Elapsed',
    jump: 'Jump',
    loadingFrame: 'Loading {frameId}…',
  },

  present: {
    prevFrameAria: 'Previous frame (←)',
    nextFrameAria: 'Next frame (→)',
    overviewAria: 'Frame overview (O)',
    ...
    shortcutNext: 'Next frame',
    shortcutPrev: 'Previous frame',
    shortcutFirstLast: 'First / last frame',
    shortcutJump: 'Jump to frame',
    shortcutOverview: 'Frame overview',
    ...
    overviewDialogAria: 'Frame overview',
    overviewEyebrow: 'Overview',
    overviewGoToAria: 'Go to frame {n}',
    nowBadge: 'Now',
  },
  ...
  inspector: {
    ...
    pickerEmpty: "No images in this frame's assets folder yet. Add some from the Assets tab.",
    ...
    commentsEmpty: 'No comments yet. Toggle Inspect and click a frame element.',
  ...
  asset: {
    ...
    sectionAria: 'Frame assets',
    eyebrow: 'Assets',
    scopeFrame: 'This frame',
    scopeGlobal: 'Global',
    ...
    deleteAssetDescription: 'Delete {name}? Imports referencing this file in the frame will break.',
    deleteAssetInUseDescription: '{name} is used in {count} place(s) across {frames} frame(s).',
    deleteAssetInUseHint: 'Deleting will revert these usages back to image placeholders.',
    deleteAndRevert: 'Delete & revert',
    toastRevertFailed: "Couldn't revert usage in {frameId}",
  ...
  thumbnailRail: {
    ...
    transitionIndicator: 'Has frame transition',
  ...
  notesDrawer: {
    ...
    placeholder: 'Write speaker notes for this frame…',
    statusSaving: 'Saving…',
    statusSaved: 'Saved',
  ...
  themes: {
    ...
    noThemesHintSuffix: ' to author one — a markdown file under themes/ plus a sibling demo frame.',
    noDemoYet: 'No demo yet',
    noDemoHintPrefix: 'Re-run ',
    noDemoHintSuffix: ' for this theme to generate a preview frame.',
    backToGallery: 'Back to themes',
    pageOf: 'page {n}/{total}',
    nextPageAria: 'Next page',
    prevPageAria: 'Previous page',
    usedBy: 'Frames using this theme',
    usedByEmpty: 'No frames use this theme yet.',
