...
// Edit live from the Design panel; consumed via `var(--of-*)` in inline styles.
...
// ─── Shared animations (injected per frame so direct-nav also works) ──────────
const styles = `
  @keyframes es-fadeUp {
    ...
    >
      ...
      <div>
        ...
        >
          ...
          <span
            style={{
              background: `linear-gradient(90deg, ${palette.accentSoft}, var(--of-accent))`,
        ...
        >
          Three steps from empty folder to a live, editable frame.
        </p>
      </div>
...
const Init: Page = () => {
  const stream: InitLine[] = [
    ...
    { kind: 'cmd', text: 'cd my-frame' },
    { kind: 'cmd', text: 'pnpm dev' },
    { kind: 'blank' },
    {
      kind: 'dim',
      text: 'Then open the dev server and start authoring in frames/<your-frame>/.',
    },
  ];
          ...
          >
            <div style={{ display: 'flex', gap: 16 }}>
              ...
              <span className="gs-type" style={{ color: palette.text }}>
                npx @open-frame/cli init my-frame
              </span>
            </div>
            <div style={{ height: 16 }} />
            {stream.map((line, i) => (
...
// ─── Frame 3: Prompt → create-frame → pages appear ───────────────────────────
const Prompt: Page = () => {
  ...
  return (
    <div style={fill}>
      ...
      >
        ...
        >
          {/* LEFT — agent CLI */}
          <WindowShell title="claude · ~/my-frame">
            <div
              style={{
                flex: 1,
                padding: '28px 36px',
            ...
            >
              ...
              <AgentLine speaker="tool" delay={2.7}>
                <div style={{ color: palette.muted }}>
                  write <span style={{ color: palette.text }}>frames/q2-launch/index.tsx</span>
                </div>
              </AgentLine>
          ...
          <WindowShell title="localhost:5173/f/q2-launch">
            <div
              style={{
                flex: 1,
                display: 'flex',
...
// ─── Frame: Visual editor (click → tweak → save) ─────────────────────────────
  ...
  return (
    <div style={fill}>
      ...
      >
        ...
        <WindowShell
          title="localhost:5173/f/q2-launch"
          badge={
            <span
              className="gs-pulse"
              style={{
  ...
  return (
    <div style={fill}>
      ...
      >
        ...
        <WindowShell title="localhost:5173/f/q2-launch · assets" style={{ flex: 1, minHeight: 0 }}>
          <div
            style={{
              flex: 1,
              background: palette.surface,
    ...
    >
      <div className="es-fadeUp">
        ...
        >
          ...
          <span style={{ fontFamily: font.mono, color: palette.accentSoft }}>@frame-comment</span>{' '}
          ...
          >
            ...
            >
              ...
              >
                ...
                {'{/* '}
                <span style={{ color: palette.accentSoft }}>@frame-comment</span> id=
            ...
            <AgentLine speaker="tool" delay={3.8}>
              <div style={{ color: palette.muted }}>
                edit <span style={{ color: palette.text }}>frames/q2-launch/index.tsx</span>{' '}
      ...
      >
        ...
        <div className="es-fadeUp" style={{ animationDelay: '0.15s' }}>
          ...
          >
            ...
            <code style={{ fontFamily: font.mono, color: palette.accentSoft }}>/create-frame</code>{' '}
        ...
        >
          <span>
            extract from a frame, image, or prose —{' '}
...
const Recap: Page = () => {
  const steps = [
    ...
    { n: '02', title: 'prompt', caption: 'create-frame' },
  ...
  return (
    <div style={fill}>
      ...
      >
        ...
        >
          <span>
            edit <span style={{ color: palette.text }}>frames/&lt;your-frame&gt;/index.tsx</span> —
            HMR does the rest
          </span>
      ...
      >
        <div className="es-fadeUp">
          ...
          >
            ...
            edit frames — no lock-in, no bespoke SDK.
          </p>
        </div>
    ...
    <div style={fill}>
      ...
      >
        <div className="es-fadeUp">
          ...
          >
            Zero layouts. Zero frame types. Zero "themes". Each page is just a React component on a
...
// ─── Frame: Git-tracked, yours forever ───────────────────────────────────────
    ...
    <div style={fill}>
      ...
      >
        <div className="es-fadeUp">
          ...
          >
            Every frame is a file in your repo. No proprietary database. No SaaS lock-in. No
        ...
        >
          <WindowShell title="~/my-frame — git log">
            <div
              style={{
                flex: 1,
                background: palette.surface,
            ...
            >
              <div style={{ color: palette.muted, marginBottom: 14 }}>
                <span style={{ color: palette.mint }}>$</span> git log --oneline frames/q2-launch/
              </div>
              {commits.map((c, i) => (
                <div
                  key={c.hash}
